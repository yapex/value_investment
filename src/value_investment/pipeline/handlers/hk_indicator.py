...
# 港股财务指标字段
HK_STOCK_INDICATOR_FIELDS: set[str] = {
    "roe",
    "roa",
    "roic",
    "gross_margin",
...
class HKStockIndicatorHandler(BaseHandler):
    """港股财务指标 Handler

    TODO: 待 HK Provider 实现 fetch_indicators 方法。
    """

    def __init__(self, provider=None):
        super().__init__(provider, "港股", HK_STOCK_INDICATOR_FIELDS)
