...
# 港股市值数据字段
HK_STOCK_MARKET_FIELDS: set[str] = {
    "market_cap",
    "pe_ratio",
    "pb_ratio",
    "total_shares",
...
class HKStockMarketHandler(BaseHandler):
    """港股市值数据 Handler

    TODO: 待 HK Provider 实现 fetch_market_data 方法。
    """

    def __init__(self, provider=None):
        super().__init__(provider, "港股", HK_STOCK_MARKET_FIELDS)
